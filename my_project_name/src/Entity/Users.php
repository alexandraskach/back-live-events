...
{   
     ...
     * @Groups({"get", "get_comment_with_author", "get_actualite_with_author"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"get", "post", "put", "get_comment_with_author", "get_actualite_with_author"})
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"get", "post", "get_comment_with_author", "get_actualite_with_author"})
     ...
     * @Groups({"post"})
     * @Assert\NotBlank(groups={"post"})
     * @Assert\Expression("this.getPassword() === this.getRetypedPassword()", message="Password does not match.", groups={"post"})
     */
