Feature: Manage blog posts
  ...
  Scenario: Create a blog post
    ...
    And I send a "POST" request to "/api/actualites" with body:
    """
    {
    ...
    """
    {
      "@context": "/api/contexts/Actualite",
      "@id": "@string@",
      "@type": "Actualite",
      "comments": [],
      "id": @integer@,
      ...
      "hydra:member":[
        {
          ...
          "@type": "Comment",
          "id": @integer@,
          "content": "Cest le premier commentaire",
          "published": "@string@.isDateTime()",
          "author": {
            "@id": "/api/users/1",
            "@type": "User",
